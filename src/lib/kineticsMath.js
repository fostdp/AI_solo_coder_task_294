export default class EnzymeKineticsMath {
    constructor(params = {}) {
        this.params = {
            Km: params.Km || 25,
    ...
    getLineweaverBurk(startS = 10, endS = 150, steps = 20) {
        const curve = [];
        const step = (endS - startS) / steps;
    ...
    getHanesWoolf(startS = 10, endS = 150, steps = 20) {
        const curve = [];
        const step = (endS - startS) / steps;
    ...
    getEadieHofstee(startS = 10, endS = 150, steps = 20) {
        const curve = [];
        const step = (endS - startS) / steps;
